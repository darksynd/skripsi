...
for i in range(0, len(data)):
    ...
    if (data[i]["eventid"] == "cowrie.session.connect"): #14
        ...
        if(".js" in resultPerLine["command"] or ".py" in resultPerLine["command"] or ".sh" in resultPerLine["command"] or resultPerLine["command"] == "sh" or "python" in resultPerLine["command"]):
        ...
        if("ipcs" in resultPerLine["command"] or "/etc/sysctl.conf" in resultPerLine["command"] or "nano /etc/sysctl.conf" in resultPerLine["command"] or "vim /etc/sysctl.conf" in resultPerLine["command"] or "cat /etc/sysctl.conf" in resultPerLine["command"] or "vi /etc/sysctl.conf" in resultPerLine["command"] or "less /etc/sysctl.conf" in resultPerLine["command"]):
            ...
            T1559 = T1559 + 1
        if("wget" in resultPerLine["command"] or "cp " in resultPerLine["command"] or resultPerLine["command"] == "sh" or "nc" in resultPerLine["command"]):
...
#            mitreList.append("T1053 (Persistence) Scheduled Task/Job")
        ...
        if("id" in resultPerLine["command"] or "who" in resultPerLine["command"] or "groups" in resultPerLine["command"] or "lastlog" in resultPerLine["command"] or "last" in resultPerLine["command"]):
            mitreList.append("T1087 (Discovery) Account Discovery")
            T1087 = T1087 + 1
        if("ls" in resultPerLine["command"] or "cd " in resultPerLine["command"] or "dir" in resultPerLine["command"] or "tree" in resultPerLine["command"] or "find " in resultPerLine["command"] or "locate " in resultPerLine["command"] or "grep " in resultPerLine["command"] or resultPerLine["command"]=="pwd"):
        ...
        if("groups" in resultPerLine["command"]):
            ...
            T1069 = T1069 + 1
        if("ps" in resultPerLine["command"] or "jobs" in resultPerLine["command"]):
        ...
        if("/var/log/apt/history.log" in resultPerLine["command"] or "less /var/log/apt/history.log" in resultPerLine["command"] or "vim /var/log/apt/history.log" in resultPerLine["command"] or "cat /var/log/apt/history.log" in resultPerLine["command"] or "nano /var/log/apt/history.log" in resultPerLine["command"] or "vi /var/log/apt/history.log" in resultPerLine["command"]):
            if "T1518 (Discovery) Software Discovery" not in mitreList:
                mitreList.append("T1518 (Discovery) Software Discovery")
                T1518 = T1518 + 1
        if("lshw" in resultPerLine["command"] or "lscpu" in resultPerLine["command"] or "hostname" in resultPerLine["command"] or "uname" in resultPerLine["command"]):
